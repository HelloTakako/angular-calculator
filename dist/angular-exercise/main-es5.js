...
var CalculatorComponent = /** @class */ (function () {
    ...
    CalculatorComponent.prototype.operate = function (event, inputValue) {
        if (inputValue === void 0) { inputValue = event.target.innerText; }
    ...
    CalculatorComponent.prototype.validateInput = function (event, inputValue) {
    ...
    CalculatorComponent.prototype.calculateResult = function () {
        ...
        if (this.inputHistory.length !== 0) {
            // first calculation
            var calculatedResult = eval(this.inputHistory.join('')).toString();
    ...
    CalculatorComponent.prototype.displayInputs = function (input) {
        this.inputHistory.push(input);
        document.getElementById('input-history').innerText = this.inputHistory.join('');
    };
    // undo user's last input
    CalculatorComponent.prototype.undoInput = function () {
    ...
    CalculatorComponent.prototype.clearInputHistory = function () {
    ...
    CalculatorComponent.prototype.handleKeyDown = function (event) {
